@extends('/admin/layout',['title'=>'Facultes'])
@section('content')
@include('admin/nav')
@if(Session::get('save'))
    <div class="alert alert-success alert-dismissible" role="alert">
        ...
        <div class="alert-message">
            <strong>Facultes!</strong> {{Session::get("save") }}
        </div>
    </div>
@endif
@if(Session::get('update'))
    <div class="alert alert-success alert-dismissible"  role="alert">
        ...
        <div class="alert-message">
            <strong>Facultes!</strong> {{Session::get("update") }}
        </div>
    </div>
@endif
@if(Session::get('delete'))
    <div class="alert alert-success alert-dismissible" role="alert">
        ...
        <div class="alert-message">
            <strong>Facultes!</strong> {{Session::get("delete") }}
        </div>
    </div>
@endif
@if(Session::get('fail'))
    <div class="alert alert-danger alert-dismissible" role="alert">
        ...
        <div class="alert-message">
            <strong>Facultes!</strong> {{Session::get("fail") }}
        </div>
    </div>
@endif
...
<div class="row" id="display">
    ...
    <div class="modal fade" id="defaultModalPrimary" tabindex="-1" aria-hidden="true" style="display: none;">
        <div class="modal-dialog" role="document">
            ...
            <form method="post" action="{{ route('save_facultes') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="text-center">Ajouter une Faculte</h3>
                    ...
                    <div class="modal-body m-3">
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2 text-sm-right">Nom de l'Universite</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2 text-sm-right">Nom de la Facultes</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" id="nom" name="nom" rows="2" placeholder="Noms des Facultes" required></textarea>
                                <span>Veuillez saisir le nom de toutes les facultes en les seperant avec virgule</span>
    ...
    <div class="modal fade" id="EditModalPrimary" tabindex="-1" aria-hidden="true" style="display: none;">
        <div class="modal-dialog" role="document">
            ...
            <form method="post" action="{{ route('update_facultes') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="text-center">Modifier une Facultes</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <h6 class="card-subtitle text-muted">
                    ce tableau nous donne les données de chaque facultés </h6>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-sm-12">
                            <table class="table table-striped dataTable dtr-inline" style="width: 100%;" role="grid" aria-describedby="datatables-buttons_info">
                                ...
                                @foreach($faculte as $value)
                                    <tr>
                                        <td>{{$count=1}}</td>
                                        <td style="display: none">{{$value->id_facultes}}</td>
                                        <td>{{$value->nom}}</td>
                                        <td>{{$value->libelle}}</td>
                                        <td>
                                            ...
                                            <a href="delete_facultes/{{$value->id_facultes}}">
