@extends('/admin/layout',['title'=>'University'])
@section('content')
@include('admin/nav')
@if(Session::get('save'))
    <div class="alert alert-success alert-dismissible" role="alert">
        ...
        <div class="alert-message">
            <strong>University!</strong> {{Session::get("save") }}
        </div>
    </div>
@endif
@if(Session::get('update'))
    <div class="alert alert-success alert-dismissible"  role="alert">
        ...
        <div class="alert-message">
            <strong>University!</strong> {{Session::get("update") }}
        </div>
    </div>
@endif
@if(Session::get('delete'))
    <div class="alert alert-success alert-dismissible" role="alert">
        ...
        <div class="alert-message">
            <strong>University!</strong> {{Session::get("delete") }}
        </div>
    </div>
@endif
@if(Session::get('fail'))
...
<div class="row">
    ...
    <div class="modal fade" id="defaultModalPrimary" tabindex="-1" aria-hidden="true" style="display: none;">
        <div class="modal-dialog" role="document">
            ...
            <form method="post" action="{{ route('save_university') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="text-center">Ajouter une universite</h3>
                    ...
                    <div class="modal-body m-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="adresse" placeholder="Adresse" name="adresse" rows="3" required></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="website" name="web" class="form-control" placeholder="WebSite" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="file" id="image" name="image" class="form-control" placeholder="Logo" required>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="EditModalPrimary" tabindex="-1" aria-hidden="true" style="display: none;">
        <div class="modal-dialog" role="document">
            ...
            <form method="post" action="{{ route('update_university') }}" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="text-center">Modifier une universite</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <h6 class="card-subtitle text-muted">
                    ce tableau nous donne les données de chaque universite </h6>
            </div>
            <div class="card-body">
