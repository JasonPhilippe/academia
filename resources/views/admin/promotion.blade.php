@extends('/admin/layout',['title'=>'Promotions'])
@section('content')
@include('admin/nav')
@if(Session::get('save'))
    <div class="alert alert-success alert-dismissible" role="alert">
        ...
        <div class="alert-message">
            <strong>Promotions!</strong> {{Session::get("save") }}
        </div>
    </div>
@endif
@if(Session::get('update'))
    <div class="alert alert-success alert-dismissible"  role="alert">
        ...
        <div class="alert-message">
            <strong>Promotions!</strong> {{Session::get("update") }}
        </div>
    </div>
@endif
@if(Session::get('delete'))
    <div class="alert alert-success alert-dismissible" role="alert">
        ...
        <div class="alert-message">
            <strong>Promotions!</strong> {{Session::get("delete") }}
        </div>
    </div>
@endif
@if(Session::get('fail'))
    <div class="alert alert-danger alert-dismissible" role="alert">
        ...
        <div class="alert-message">
            <strong>Promotions!</strong> {{Session::get("fail") }}
        </div>
    </div>
@endif
...
<div class="row" id="display">
    ...
    <div class="modal fade" id="defaultModalPrimary" tabindex="-1" aria-hidden="true" style="display: none;">
        <div class="modal-dialog" role="document">
            ...
            <form method="post" action="{{ route('save_promotion') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="text-center">Ajouter les Promotions</h3>
                    ...
                    <div class="modal-body m-3">
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2 text-sm-right">Nom des Promotions</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" id="nom" name="nom" rows="2" placeholder="G1,G2,G3,...." required></textarea>
                                <span>Veuillez saisir le nom de toutes les promotions en les seperant avec virgule</span>
                                <span style="color: red">@error('nom'){{ $message }}@enderror</span>

                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2 text-sm-right">Nom de Départements</label>
                            <div class="col-sm-10">
                                <select class="form-control mb-3" name="departement[]"  multiple="multiple">
    ...
    <div class="modal fade" id="EditModalPrimary" tabindex="-1" aria-hidden="true" style="display: none;">
        <div class="modal-dialog" role="document">
            ...
            <form method="post" action="{{ route('update_promotion') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="text-center">Modifier une Promotion</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    <div class="modal-body m-3">
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2 text-sm-right">Nom de la Promotion</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2 text-sm-right">Noms des Départements</label>
                            <div class="col-sm-10">
                                <select class="form-control mb-3" name="departement">
                                    @foreach($data as $item)
                                        <option value="{{ $item->id_departement }}">{{ $item->nom_departement }}</option>
                                    @endforeach
                                </select>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <h6 class="card-subtitle text-muted">
                    ce tableau nous donne les données de chaque promotion </h6>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-sm-12">
                            <table class="table table-striped dataTable dtr-inline" style="width: 100%;" role="grid" aria-describedby="datatables-buttons_info">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1" style="width: 164px;" aria-label="Salary: activate to sort column ascending">Nom des Promotions</th>
                                    <th class="sorting" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1" style="width: 164px;" aria-label="Salary: activate to sort column ascending">Nom des Departements</th>
                                    <th class="sorting" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1" style="width: 164px;" aria-label="Salary: activate to sort column ascending">Nom de la Faculté</th>
                                ...
                                @foreach($promotions as $value)
                                    <tr>
                                        <td>{{$count=1}}</td>
                                        <td style="display: none">{{$value->id_promotion}}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="delete_promotion/{{$value->id_promotion}}">
                                ...
                                <tr>
                                    ...
                                    <th rowspan="1" colspan="1">Nom des Promotions</th>
                                    <th rowspan="1" colspan="1">Nom des Departements</th>
                                    <th rowspan="1" colspan="1">Nom de la Faculté</th>
